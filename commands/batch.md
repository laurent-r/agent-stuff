...
<!--
name: 'Agent Prompt: /batch slash command' (https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/agent-prompt-batch-slash-command.md)
